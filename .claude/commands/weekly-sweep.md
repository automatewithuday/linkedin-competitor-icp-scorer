...
Read README.md, docs/OPERATIONS.md and targets.txt. For each nonblank, noncomment target URL run the documented pipeline with the user's ICP and a distinct target/date slug. Start with 10 posts and a maximum 100 qualified Prospeo lookups per target unless the user has specified other limits.
